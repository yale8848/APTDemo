...
import ren.yale.android.aptdemoviewfindercomp.TypeUtil;
...
public class AnnotatedClass {
    ...
    public List<ren.yale.android.aptdemoviewfindercomp.model.BindViewField> mFields;
    public List<ren.yale.android.aptdemoviewfindercomp.model.OnClickMethod> mMethods;
    ...
    public void addField(ren.yale.android.aptdemoviewfindercomp.model.BindViewField field) {
        mFields.add(field);
    }

    public void addMethod(ren.yale.android.aptdemoviewfindercomp.model.OnClickMethod method) {
        mMethods.add(method);
    }
    ...
    public JavaFile generateFinder() {
        ...
        for (ren.yale.android.aptdemoviewfindercomp.model.BindViewField field : mFields) {
            // find views
        ...
        for (ren.yale.android.aptdemoviewfindercomp.model.OnClickMethod method : mMethods) {
